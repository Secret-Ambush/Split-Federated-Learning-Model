...
Original file is located at
    https://colab.research.google.com/drive/1bU_9tXC5uhJ_nZWqGPvYErLPTS008cGa

# Optimized AlexNet Split Federated Learning with GPU
...
# GPU-friendly AlexNet implementation
class SplitAlexNet(nn.Module):
    def __init__(self, num_classes):
        ...
        # GPU-optimized pooling
        self.global_pool = nn.AdaptiveAvgPool2d((1, 1))  # Global average pooling
        self.fc = nn.Linear(256, num_classes)  # Adjust input size based on your model
...
class ExperimentConfig:
    def __init__(self):
        ...
        # Model Configuration
        self.MODEL_LIST = [("AlexNet", SplitAlexNet)]

        # File Paths
        self.LOG_PATH = "/content/drive/MyDrive/Riddhi/alexNet_accuracy_log.txt"
        self.CSV_PATH = "/content/drive/MyDrive/Riddhi/final_dataset.csv"
        self.FINAL_OUTPUT_PATH = "/content/drive/MyDrive/Riddhi/alexNet_finalResults.csv"
        self.CHECKPOINT_DIR = "/content/drive/MyDrive/Riddhi/alexnet_checkpoints"
        self.PROGRESS_FILE = "/content/drive/MyDrive/Riddhi/alexnet_progress.json"
...
LOG_PATH = "/content/drive/MyDrive/Riddhi/alexNet_accuracy_log.txt"
