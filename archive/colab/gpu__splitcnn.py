...
Original file is located at
    https://colab.research.google.com/drive/1kG7704rjxSUJzxT_FezJAQW82BW-kVo9

# Optimized SplitCNN Split Federated Learning with GPU
...
class SplitCNN(nn.Module):
    def __init__(self, num_classes):
        ...
        # Custom CNN architecture split into 3 blocks
...
class ExperimentConfig:
    def __init__(self):
        ...
        # Model Configuration
        self.MODEL_LIST = [("SplitCNN", SplitCNN)]

        # File Paths
        self.LOG_PATH = "/content/drive/MyDrive/Riddhi/splitCNN_accuracy_log.txt"
        self.CSV_PATH = "/content/drive/MyDrive/Riddhi/final_dataset.csv"
        self.FINAL_OUTPUT_PATH = "/content/drive/MyDrive/Riddhi/splitCNN_finalResults.csv"
        self.CHECKPOINT_DIR = "/content/drive/MyDrive/Riddhi/splitCNN_checkpoints"
        self.PROGRESS_FILE = "/content/drive/MyDrive/Riddhi/splitCNN_progress.json"
...
def get_cut_layers_for_model(model):
    ...
    - 0  = full model on server
    - -1 = full model on client
    """
    cut_layers = []
...
LOG_PATH = "/content/drive/MyDrive/Riddhi/splitCNN_accuracy_log.txt"
